...
class Functions_Base64 {
	 ...
	 */
	protected static String encodeString(String s) {
	 ...
	 */
	protected static String encodeLines(byte[] in) {
	 ...
	 * @return A String containing the Base64 encoded data, broken into lines.
	 */
	protected static String encodeLines(byte[] in, int iOff, int iLen, int lineLen, String lineSeparator) {
	 ...
	 */
	protected static char[] encode(byte[] in) {
	 ...
	 * @return A character array containing the Base64 encoded data.
	 */
	protected static char[] encode(byte[] in, int iLen) {
	 ...
	 * @return A character array containing the Base64 encoded data.
	 */
	protected static char[] encode(byte[] in, int iOff, int iLen) {
	 ...
	 *             If the input is not valid Base64 encoded data.
	 */
	protected static byte[] decodeLines(String s) {
	 ...
	 *             If the input is not valid Base64 encoded data.
	 */
	protected static byte[] decode(char[] in) {
	 ...
	 *             If the input is not valid Base64 encoded data.
	 */
	protected static byte[] decode(char[] in, int iOff, int iLen) {
		if (iLen % 4 != 0)
